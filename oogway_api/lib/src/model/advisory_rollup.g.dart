...
class _$AdvisoryRollup extends AdvisoryRollup {
  ...
  factory _$AdvisoryRollup([void Function(AdvisoryRollupBuilder)? updates]) =>
      (new AdvisoryRollupBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('AdvisoryRollup')
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'AdvisoryRollup', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
