...
class _$OrganizationGroup extends OrganizationGroup {
  ...
  factory _$OrganizationGroup(
      ...
      (new OrganizationGroupBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OrganizationGroup')
...
class OrganizationGroupBuilder
  ...
  @override
  OrganizationGroup build() => _build();

  _$OrganizationGroup _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'OrganizationGroup', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
