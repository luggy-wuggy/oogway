...
class _$RatingObjectGetRatingResponse404
  ...
  factory _$RatingObjectGetRatingResponse404(
      ...
      (new RatingObjectGetRatingResponse404Builder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RatingObjectGetRatingResponse404')
...
class RatingObjectGetRatingResponse404Builder
  ...
  @override
  RatingObjectGetRatingResponse404 build() => _build();

  _$RatingObjectGetRatingResponse404 _build() {
    final _$result = _$v ??
