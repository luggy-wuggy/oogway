...
class _$CategoryCollectionCausesItem extends CategoryCollectionCausesItem {
  ...
  factory _$CategoryCollectionCausesItem(
      ...
      (new CategoryCollectionCausesItemBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('CategoryCollectionCausesItem')
          ..add('causeID', causeID)
...
class CategoryCollectionCausesItemBuilder
  ...
  @override
  _$CategoryCollectionCausesItem build() {
    final _$result = _$v ??
