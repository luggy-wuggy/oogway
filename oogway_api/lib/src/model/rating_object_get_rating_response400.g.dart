...
class _$RatingObjectGetRatingResponse400
  ...
  factory _$RatingObjectGetRatingResponse400(
      ...
      (new RatingObjectGetRatingResponse400Builder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RatingObjectGetRatingResponse400')
...
class RatingObjectGetRatingResponse400Builder
  ...
  @override
  RatingObjectGetRatingResponse400 build() => _build();

  _$RatingObjectGetRatingResponse400 _build() {
    final _$result = _$v ??
