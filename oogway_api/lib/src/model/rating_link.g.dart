...
class _$RatingLink extends RatingLink {
  ...
  factory _$RatingLink([void Function(RatingLinkBuilder)? updates]) =>
      (new RatingLinkBuilder()..update(updates)).build();
  ...
  _$RatingLink._(
      ...
      required this.links})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(links, 'RatingLink', 'links');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('RatingLink')
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'RatingLink', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
