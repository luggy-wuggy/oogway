...
class _$RatingCollectionLink extends RatingCollectionLink {
  ...
  factory _$RatingCollectionLink(
      ...
      (new RatingCollectionLinkBuilder()..update(updates)).build();

  _$RatingCollectionLink._({required this.links}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        links, 'RatingCollectionLink', 'links');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('RatingCollectionLink')
          ..add('links', links))
        .toString();
  }
}
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'RatingCollectionLink', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
