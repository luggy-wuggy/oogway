...
class _$AccountabilityRating extends AccountabilityRating {
  ...
  factory _$AccountabilityRating(
      ...
      (new AccountabilityRatingBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('AccountabilityRating')
          ..add('score', score)
          ..add('rating', rating)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'AccountabilityRating', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
