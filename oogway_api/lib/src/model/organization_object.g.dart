...
class _$OrganizationObject extends OrganizationObject {
  ...
  factory _$OrganizationObject(
      ...
      (new OrganizationObjectBuilder()..update(updates))._build();
  ...
  _$OrganizationObject._(
      ...
      this.ratingHistory})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(ein, r'OrganizationObject', 'ein');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OrganizationObject')
          ..add('ein', ein)
          ..add('orgID', orgID)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'OrganizationObject', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
