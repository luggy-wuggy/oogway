...
class _$ActiveAdvisoryCollectionItem extends ActiveAdvisoryCollectionItem {
  ...
  factory _$ActiveAdvisoryCollectionItem(
      ...
      (new ActiveAdvisoryCollectionItemBuilder()..update(updates))._build();

  _$ActiveAdvisoryCollectionItem._(
      {this.mailingAddress, required this.organization, this.advisories})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        organization, r'ActiveAdvisoryCollectionItem', 'organization');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ActiveAdvisoryCollectionItem')
...
class ActiveAdvisoryCollectionItemBuilder
  ...
  @override
  ActiveAdvisoryCollectionItem build() => _build();

  _$ActiveAdvisoryCollectionItem _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ActiveAdvisoryCollectionItem', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
