...
class _$OrganizationCollectionCategory extends OrganizationCollectionCategory {
  ...
  factory _$OrganizationCollectionCategory(
      ...
      (new OrganizationCollectionCategoryBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OrganizationCollectionCategory')
...
class OrganizationCollectionCategoryBuilder
  ...
  @override
  OrganizationCollectionCategory build() => _build();

  _$OrganizationCollectionCategory _build() {
    final _$result = _$v ??
