...
part 'organization_collection_mailing_address.g.dart';
...
abstract class OrganizationCollectionMailingAddress implements Built<OrganizationCollectionMailingAddress, OrganizationCollectionMailingAddressBuilder> {
    ...
    OrganizationCollectionMailingAddress._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(OrganizationCollectionMailingAddressBuilder b) => b;

    factory OrganizationCollectionMailingAddress([void updates(OrganizationCollectionMailingAddressBuilder b)]) = _$OrganizationCollectionMailingAddress;

    @BuiltValueSerializer(custom: true)
    static Serializer<OrganizationCollectionMailingAddress> get serializer => _$OrganizationCollectionMailingAddressSerializer();
}

class _$OrganizationCollectionMailingAddressSerializer implements StructuredSerializer<OrganizationCollectionMailingAddress> {
    @override
    final Iterable<Type> types = const [OrganizationCollectionMailingAddress, _$OrganizationCollectionMailingAddress];

    @override
    final String wireName = r'OrganizationCollectionMailingAddress';

    @override
    Iterable<Object?> serialize(Serializers serializers, OrganizationCollectionMailingAddress object,
    ...
    @override
    OrganizationCollectionMailingAddress deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = OrganizationCollectionMailingAddressBuilder();
