...
class _$FinancialRating extends FinancialRating {
  ...
  factory _$FinancialRating([void Function(FinancialRatingBuilder)? updates]) =>
      (new FinancialRatingBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('FinancialRating')
          ..add('score', score)
          ..add('rating', rating)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'FinancialRating', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
