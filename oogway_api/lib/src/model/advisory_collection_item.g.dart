...
class _$AdvisoryCollectionItem extends AdvisoryCollectionItem {
  ...
  factory _$AdvisoryCollectionItem(
      ...
      (new AdvisoryCollectionItemBuilder()..update(updates)).build();
  ...
  _$AdvisoryCollectionItem._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        sources, 'AdvisoryCollectionItem', 'sources');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('AdvisoryCollectionItem')
...
class AdvisoryCollectionItemBuilder
  ...
  @override
  _$AdvisoryCollectionItem build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'AdvisoryCollectionItem', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
