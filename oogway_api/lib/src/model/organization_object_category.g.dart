...
class _$OrganizationObjectCategory extends OrganizationObjectCategory {
  ...
  factory _$OrganizationObjectCategory(
      ...
      (new OrganizationObjectCategoryBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('OrganizationObjectCategory')
...
class OrganizationObjectCategoryBuilder
  ...
  @override
  _$OrganizationObjectCategory build() {
    final _$result = _$v ??
