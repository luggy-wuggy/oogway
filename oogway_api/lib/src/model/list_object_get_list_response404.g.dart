...
class _$ListObjectGetListResponse404 extends ListObjectGetListResponse404 {
  ...
  factory _$ListObjectGetListResponse404(
      ...
      (new ListObjectGetListResponse404Builder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ListObjectGetListResponse404')
...
class ListObjectGetListResponse404Builder
  ...
  @override
  _$ListObjectGetListResponse404 build() {
    final _$result =
