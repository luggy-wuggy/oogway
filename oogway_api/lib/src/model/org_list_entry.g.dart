...
class _$OrgListEntry extends OrgListEntry {
  ...
  factory _$OrgListEntry([void Function(OrgListEntryBuilder)? updates]) =>
      (new OrgListEntryBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OrgListEntry')
          ..add('rank', rank)
...
class OrgListEntryBuilder
  ...
  @override
  OrgListEntry build() => _build();

  _$OrgListEntry _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'OrgListEntry', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
