...
class _$OrganizationCollectionAdvisories
  ...
  factory _$OrganizationCollectionAdvisories(
      ...
      (new OrganizationCollectionAdvisoriesBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('OrganizationCollectionAdvisories')
...
class OrganizationCollectionAdvisoriesBuilder
  ...
  @override
  _$OrganizationCollectionAdvisories build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'OrganizationCollectionAdvisories', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
