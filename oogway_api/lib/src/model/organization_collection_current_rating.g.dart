...
class _$OrganizationCollectionCurrentRating
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OrganizationCollectionCurrentRating')
...
class OrganizationCollectionCurrentRatingBuilder
  ...
  @override
  OrganizationCollectionCurrentRating build() => _build();

  _$OrganizationCollectionCurrentRating _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'OrganizationCollectionCurrentRating',
            _$failedField,
            e.toString());
      }
      rethrow;
