...
class _$OrganizationCollectionItem extends OrganizationCollectionItem {
  ...
  factory _$OrganizationCollectionItem(
      ...
      (new OrganizationCollectionItemBuilder()..update(updates)).build();
  ...
  _$OrganizationCollectionItem._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        ein, 'OrganizationCollectionItem', 'ein');
    BuiltValueNullFieldError.checkNotNull(
        organization, 'OrganizationCollectionItem', 'organization');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('OrganizationCollectionItem')
          ..add('ein', ein)
          ..add('orgID', orgID)
...
class OrganizationCollectionItemBuilder
  ...
  @override
  _$OrganizationCollectionItem build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'OrganizationCollectionItem', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
