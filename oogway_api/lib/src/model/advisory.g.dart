...
class _$Advisory extends Advisory {
  ...
  factory _$Advisory([void Function(AdvisoryBuilder)? updates]) =>
      (new AdvisoryBuilder()..update(updates))._build();
  ...
  _$Advisory._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(sources, r'Advisory', 'sources');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Advisory')
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'Advisory', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
