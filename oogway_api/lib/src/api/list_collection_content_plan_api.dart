...
import 'package:oogway_api/src/model/list_collection_get_lists_response400.dart';
import 'package:oogway_api/src/model/list_collection_get_lists_response404.dart';
import 'package:oogway_api/src/model/list_object_link.dart';

class ListCollectionContentPlanApi {

  final Dio _dio;

  final Serializers _serializers;

  const ListCollectionContentPlanApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ListObjectLink>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<ListObjectLink>>> getLists({ 
    ...
    BuiltList<ListObjectLink> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(ListObjectLink)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<ListObjectLink>;
    ...
    return Response<BuiltList<ListObjectLink>>(
      data: _responseData,
