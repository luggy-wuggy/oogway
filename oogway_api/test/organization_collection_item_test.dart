...
// tests for OrganizationCollectionItem
void main() {
  final instance = OrganizationCollectionItemBuilder();
  // TODO add properties to the builder and call build()

  group(OrganizationCollectionItem, () {
    ...
    test('to test the property `advisories`', () async {
      // TODO
    });
