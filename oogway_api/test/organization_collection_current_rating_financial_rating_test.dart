...
// tests for OrganizationCollectionCurrentRatingFinancialRating
void main() {
  final instance = OrganizationCollectionCurrentRatingFinancialRatingBuilder();
  // TODO add properties to the builder and call build()

  group(OrganizationCollectionCurrentRatingFinancialRating, () {
