...
void main() {
  ...
  group(Form990, () {
    ...
    test('to test the property `fundraisingExpenses`', () async {
      // TODO
    });
    ...
    test('to test the property `administrativeExpenses`', () async {
      // TODO
    });
    ...
    // num programExpenses
    test('to test the property `programExpenses`', () async {
      // TODO
    });
    ...
    // num totalExpenses
    test('to test the property `totalExpenses`', () async {
      // TODO
    });
    ...
    // num totalNetAssets
    test('to test the property `totalNetAssets`', () async {
      // TODO
    });
    ...
    test('to test the property `totalContributions`', () async {
      // TODO
    });
    ...
    // num primaryRevenue
    test('to test the property `primaryRevenue`', () async {
      // TODO
    });
    ...
    // num otherRevenue
    test('to test the property `otherRevenue`', () async {
      // TODO
    });
    ...
    test('to test the property `ceoCompensationPercent`', () async {
      // TODO
    });
