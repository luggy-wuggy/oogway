...
// tests for OrganizationObject
void main() {
  final instance = OrganizationObjectBuilder();
  // TODO add properties to the builder and call build()

  group(OrganizationObject, () {
    ...
    // String generalEmail
    test('to test the property `generalEmail`', () async {
      // TODO
    });
    ...
    test('to test the property `irsClassification`', () async {
      // TODO
    });

    // Address mailingAddress
    test('to test the property `mailingAddress`', () async {
      // TODO
    });

    // Address donationAddress
    test('to test the property `donationAddress`', () async {
      // TODO
    });

    // AdvisoryCollectionLink activeAdvisories
    test('to test the property `activeAdvisories`', () async {
      // TODO
    });

    // AdvisoryCollectionLink removedAdvisories
    test('to test the property `removedAdvisories`', () async {
      // TODO
    });

    // Representative currentBoardChair
    test('to test the property `currentBoardChair`', () async {
      // TODO
    });

    // Representative currentCEO
    test('to test the property `currentCEO`', () async {
      // TODO
    });

    // RatingLink currentRating
    test('to test the property `currentRating`', () async {
      // TODO
    });

    // RatingCollectionLink ratingHistory
    test('to test the property `ratingHistory`', () async {
      // TODO
    });
