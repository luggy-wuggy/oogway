...
// tests for OrganizationCollectionCurrentRatingAccountabilityRating
void main() {
  final instance = OrganizationCollectionCurrentRatingAccountabilityRatingBuilder();
  // TODO add properties to the builder and call build()

  group(OrganizationCollectionCurrentRatingAccountabilityRating, () {
