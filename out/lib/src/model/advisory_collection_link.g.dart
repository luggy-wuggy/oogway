...
class _$AdvisoryCollectionLink extends AdvisoryCollectionLink {
  ...
  factory _$AdvisoryCollectionLink(
      ...
      (new AdvisoryCollectionLinkBuilder()..update(updates))._build();

  _$AdvisoryCollectionLink._({required this.links}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        links, r'AdvisoryCollectionLink', 'links');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AdvisoryCollectionLink')
          ..add('links', links))
        .toString();
  }
}
...
class AdvisoryCollectionLinkBuilder
  ...
  @override
  AdvisoryCollectionLink build() => _build();

  _$AdvisoryCollectionLink _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'AdvisoryCollectionLink', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
