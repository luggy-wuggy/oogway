...
class _$OrganizationCollectionCause extends OrganizationCollectionCause {
  ...
  factory _$OrganizationCollectionCause(
      ...
      (new OrganizationCollectionCauseBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OrganizationCollectionCause')
          ..add('causeID', causeID)
...
class OrganizationCollectionCauseBuilder
  ...
  @override
  OrganizationCollectionCause build() => _build();

  _$OrganizationCollectionCause _build() {
    final _$result = _$v ??
