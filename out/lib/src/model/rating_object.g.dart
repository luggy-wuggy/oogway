...
class _$RatingObject extends RatingObject {
  ...
  factory _$RatingObject([void Function(RatingObjectBuilder)? updates]) =>
      (new RatingObjectBuilder()..update(updates))._build();
  ...
  _$RatingObject._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        includedOrganizations, r'RatingObject', 'includedOrganizations');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RatingObject')
...
class RatingObjectBuilder
  ...
  @override
  RatingObject build() => _build();

  _$RatingObject _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'RatingObject', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
