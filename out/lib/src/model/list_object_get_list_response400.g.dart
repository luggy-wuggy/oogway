...
class _$ListObjectGetListResponse400 extends ListObjectGetListResponse400 {
  ...
  factory _$ListObjectGetListResponse400(
      ...
      (new ListObjectGetListResponse400Builder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ListObjectGetListResponse400')
...
class ListObjectGetListResponse400Builder
  ...
  @override
  ListObjectGetListResponse400 build() => _build();

  _$ListObjectGetListResponse400 _build() {
    final _$result =
