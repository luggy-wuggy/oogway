...
part 'organization_collection_irs_classification.g.dart';

/// The classification and tax treatment of the Organization by the Internal Revenue Service.
///
/// Properties:
...
abstract class OrganizationCollectionIrsClassification implements Built<OrganizationCollectionIrsClassification, OrganizationCollectionIrsClassificationBuilder> {
    ...
    OrganizationCollectionIrsClassification._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(OrganizationCollectionIrsClassificationBuilder b) => b;

    factory OrganizationCollectionIrsClassification([void updates(OrganizationCollectionIrsClassificationBuilder b)]) = _$OrganizationCollectionIrsClassification;

    @BuiltValueSerializer(custom: true)
    static Serializer<OrganizationCollectionIrsClassification> get serializer => _$OrganizationCollectionIrsClassificationSerializer();
}

class _$OrganizationCollectionIrsClassificationSerializer implements StructuredSerializer<OrganizationCollectionIrsClassification> {
    @override
    final Iterable<Type> types = const [OrganizationCollectionIrsClassification, _$OrganizationCollectionIrsClassification];

    @override
    final String wireName = r'OrganizationCollectionIrsClassification';

    @override
    Iterable<Object?> serialize(Serializers serializers, OrganizationCollectionIrsClassification object,
    ...
    @override
    OrganizationCollectionIrsClassification deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = OrganizationCollectionIrsClassificationBuilder();
