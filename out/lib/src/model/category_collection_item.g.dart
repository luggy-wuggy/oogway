...
class _$CategoryCollectionItem extends CategoryCollectionItem {
  ...
  factory _$CategoryCollectionItem(
      ...
      (new CategoryCollectionItemBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'CategoryCollectionItem')
...
class CategoryCollectionItemBuilder
  ...
  @override
  CategoryCollectionItem build() => _build();

  _$CategoryCollectionItem _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'CategoryCollectionItem', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
