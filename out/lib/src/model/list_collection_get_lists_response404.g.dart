...
class _$ListCollectionGetListsResponse404
  ...
  factory _$ListCollectionGetListsResponse404(
      ...
      (new ListCollectionGetListsResponse404Builder()..update(updates))
          ._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ListCollectionGetListsResponse404')
...
class ListCollectionGetListsResponse404Builder
  ...
  @override
  ListCollectionGetListsResponse404 build() => _build();

  _$ListCollectionGetListsResponse404 _build() {
    final _$result = _$v ??
