...
class _$ListObjectLink extends ListObjectLink {
  ...
  factory _$ListObjectLink([void Function(ListObjectLinkBuilder)? updates]) =>
      (new ListObjectLinkBuilder()..update(updates))._build();
  ...
  _$ListObjectLink._(
      ...
      this.sortOrder})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(links, r'ListObjectLink', 'links');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ListObjectLink')
          ..add('links', links)
          ..add('listID', listID)
...
class ListObjectLinkBuilder
  ...
  @override
  ListObjectLink build() => _build();

  _$ListObjectLink _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ListObjectLink', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
