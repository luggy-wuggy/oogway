...
class _$ListCollectionGetListsResponse400
  ...
  factory _$ListCollectionGetListsResponse400(
      ...
      (new ListCollectionGetListsResponse400Builder()..update(updates))
          ._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ListCollectionGetListsResponse400')
...
class ListCollectionGetListsResponse400Builder
  ...
  @override
  ListCollectionGetListsResponse400 build() => _build();

  _$ListCollectionGetListsResponse400 _build() {
    final _$result = _$v ??
