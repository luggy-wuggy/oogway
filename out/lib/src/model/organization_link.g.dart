...
class _$OrganizationLink extends OrganizationLink {
  ...
  factory _$OrganizationLink(
      ...
      (new OrganizationLinkBuilder()..update(updates))._build();

  _$OrganizationLink._(
      {required this.ein, this.charityName, required this.links})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(ein, r'OrganizationLink', 'ein');
    BuiltValueNullFieldError.checkNotNull(links, r'OrganizationLink', 'links');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'OrganizationLink')
          ..add('ein', ein)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'OrganizationLink', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
