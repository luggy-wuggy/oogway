...
import 'package:openapi/src/model/accountability_rating.dart';
import 'package:openapi/src/model/accountability_tests.dart';
...
import 'package:openapi/src/model/active_advisory_collection_mailing_address.dart';
import 'package:openapi/src/model/active_advisory_collection_organization.dart';
import 'package:openapi/src/model/address.dart';
import 'package:openapi/src/model/advisory.dart';
...
import 'package:openapi/src/model/advisory_object_get_advisory_response400.dart';
import 'package:openapi/src/model/advisory_object_get_advisory_response404.dart';
import 'package:openapi/src/model/advisory_rollup.dart';
import 'package:openapi/src/model/advisory_source.dart';
import 'package:openapi/src/model/category_collection_causes_item.dart';
import 'package:openapi/src/model/category_collection_item.dart';
import 'package:openapi/src/model/deductibility_type.dart';
import 'package:openapi/src/model/financial_rating.dart';
...
import 'package:openapi/src/model/list_collection_get_lists_response400.dart';
import 'package:openapi/src/model/list_collection_get_lists_response404.dart';
import 'package:openapi/src/model/list_object_get_list_response400.dart';
import 'package:openapi/src/model/list_object_get_list_response404.dart';
import 'package:openapi/src/model/list_object_link.dart';
import 'package:openapi/src/model/model_list.dart';
import 'package:openapi/src/model/org_list_entry.dart';
...
import 'package:openapi/src/model/organization_collection_current_rating_accountability_rating.dart';
import 'package:openapi/src/model/organization_collection_current_rating_financial_rating.dart';
...
import 'package:openapi/src/model/organization_collection_item.dart';
import 'package:openapi/src/model/organization_collection_mailing_address.dart';
import 'package:openapi/src/model/organization_collection_search_organizations_response400.dart';
import 'package:openapi/src/model/organization_collection_search_organizations_response404.dart';
import 'package:openapi/src/model/organization_group.dart';
import 'package:openapi/src/model/organization_link.dart';
import 'package:openapi/src/model/organization_object.dart';
...
import 'package:openapi/src/model/organization_object_get_organization_response400.dart';
import 'package:openapi/src/model/organization_object_get_organization_response404.dart';
...
import 'package:openapi/src/model/rating_collection_get_ratings_response400.dart';
import 'package:openapi/src/model/rating_collection_get_ratings_response404.dart';
...
@SerializersFor([
  ...
  PassFailOrNotReported,
  PassFailOrOptOut,
  PassFailOrPartial,
  PassFailOrRemediated,
  PerformanceMetrics,
...
Serializers serializers = (_$serializers.toBuilder()
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(AdvisoryCollectionItem)]),
        () => ListBuilder<AdvisoryCollectionItem>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(CategoryCollectionItem)]),
        () => ListBuilder<CategoryCollectionItem>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(ListObjectLink)]),
        () => ListBuilder<ListObjectLink>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(ActiveAdvisoryCollectionItem)]),
        () => ListBuilder<ActiveAdvisoryCollectionItem>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(OrganizationCollectionItem)]),
        () => ListBuilder<OrganizationCollectionItem>(),
      )
      ..addBuilderFactory(
        const FullType(BuiltList, [FullType(RatingLink)]),
        () => ListBuilder<RatingLink>(),
      )
